...
export const getLevelStoryBoard = async (req, res) => {
    try {
        ...
        const storyBoardLevels = await levelStoryBoardModel.find({ companyId,storyBoardId }).populate("levelId");

        console.log(storyBoardLevels)
