...
router.post('/stories', tokenVerification, async (req, res) => {
    try {
        ...
        const emailFromToken = req.emailFromToken;
...
router.put('/stories/:id', tokenVerification, async (req, res) => {
    try {
        ...
        console.log("Update data:", { storyName, description, integrations, complementaryDatasets });
        ...
        res.status(200).send({ message: "Story updated successfully", story: updatedStory });
    } catch (err) {
...
router.delete('/stories/:id', tokenVerification, async (req, res) => {
    try {
        ...
        res.status(200).send({ message: "Story deleted successfully", story: deletedStory });
    } catch (err) {
